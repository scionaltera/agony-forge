...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-10 offset-1">
            ...
            <p>The Agony Forge may collect and store Personally Identifiable Information (PII) including but not limited to IP addresses, hostnames and browser characteristics. PII collected is never shared with any third parties except as required by law.</p>
            <p>During the course of playing The Agony Forge you may interact with other players or site administrators. We do not regulate, cannot control and do not record these interactions. If you choose to divulge PII during your interactions with other players or site administrators that is solely your choice and you alone bear any consequences arising from it.</p>
            <p>The Agony Forge requires the use of browser cookies to function properly. By using the site you acknowledge and accept that cookies may be generated in your browser.</p>
            <p>Any cookies that The Agony Forge generates are strictly for one of the following purposes:</p>
            <ul>
